...
On Day 1, our focus is on gate-level modeling using Verilog. We will design and simulate basic logic gates—AND, OR, NOT, NAND, NOR, XOR, and XNOR. This exercise will allow us to observe the behavior of these gates under different input conditions, including logic values 0, 1, x (unknown), and z (high-impedance).
